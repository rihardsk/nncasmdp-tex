...
Monte Carlo metodes pielietojot gradienta aprēķiniem actor-only piegājienā, ir novērots, ka tās saistās ir lielas variances ieviešanu rezultātos.
Ar dažādiem paņēmieniem ar šo efektu ir iespējams cīnīties, bet, kā vēlāk redzēsim, actor-critic piegājienā no šo metožu izmantošanas ir iespējams izvairīties vispār. %TODO: kas atrisina saistītās problēmas.?
