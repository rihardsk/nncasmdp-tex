...
Šis paņēmiens ir idejiski tuvāks vērtības aproksimācijas metodēm, bet, kā vēlāk redzēsim, ir izmantojams arī actor-critic metodēs, lai iegūtu $V^*$ aproksimāciju.
...
\begin{itemize}
	...
	\begin{itemize}
		\item[--] veic stohastiskā gradient descent soli $NTV$ parametriem $\theta_t$ pa funkciju, kas izsaka $\left(NTV_{\theta_t}(s_t) - r_t\right)^2$ atkarībā no $\theta_t$; iegūst $\theta_{t+1}$; %TODO šis jādziens jāpaskaidro 2. nodaļā
